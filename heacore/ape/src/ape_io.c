...
/*
 * $Log: ape_io.c,v $
 * Revision 1.89  2015/08/26 17:08:44  peachey
 * In test for handling the error case of duplicated "mode" parameter,
 * make sure both copies of the line are valid. This is because otherwise
 * the errors in the individual line will be detected and reported instead
 * of just the fact that the line is duplicated.
 *

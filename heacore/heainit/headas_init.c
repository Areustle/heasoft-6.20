...
/*  int chatter=0; */
  ...
  /* $Name: heasoft6_20_20170113 $.  Before setting the tool version, we want to strip */
  /* the CVS formatting, namely "$Name: heasoft6_20_20170113 $" at the */
  /* end. */
...
/******************************************************************************
 * $Log: headas_init.c,v $
 * Revision 1.20  2014/01/08 15:36:21  peachey
 * Back out addition of new start-up and ahlog binding
 * until integration issues can be addressed.
 *

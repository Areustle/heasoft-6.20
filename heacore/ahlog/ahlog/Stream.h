...
namespace st_stream {
  ...
  class OStream {
    public:
      ...
      */
      ...
      bool getEnable(void) {return m_enabled; }
  ...
  */
  class Precision {
    public:
      /** \brief Create a Precision object with the given precision.
          \param precision The precision.
      */
      Precision(int precision): m_precision(precision) {}

      /** \brief Functor operator which modifies the precision of the target stream.
          \param os The output stream whose precision level will be set.
      */
      OStream & operator()(OStream & os) const { os.precision(m_precision); return os; }

    private:
      unsigned int m_precision;
  };

  /** \brief Shift operator used to shift a Precision object to an OStream object.
      \param os The OStream object acted upon by the Precision object.
      \param precision The Precision object which modifies the OStream object.
  */
  inline OStream & operator <<(OStream & os, const Precision & precision) { return precision(os); }

  inline Precision setprecision(int precision) { return Precision(precision); }

 ...
 *                               fits file format
 *              NS  25/10/2010 - Modified to be included in NuSTAR libraries
 */ 

#ifndef NU_HIGHFITS_H
#define NU_HIGHFITS_H
...
extern int CopyHDUExt(char *infile, char *outfile, char *extname);

extern int GetHDUExtNum(char *infile, char *extname, int *extnum);

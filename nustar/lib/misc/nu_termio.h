/*
 *	nu_termio.h: --- terminal input/output module ---
 *
 *	DESCRIPTION:
...
extern int RenameFile(char *source, char *destination);
extern int CreateAbsSymbolicLink(char *filename, char *linkname);

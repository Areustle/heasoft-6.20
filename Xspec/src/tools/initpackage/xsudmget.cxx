...
/* $Id: xsudmget.cxx,v 1.3 2011/01/13 23:13:52 gordon Exp $
...
static int find_used (int retval,int elsize);
...
static int check_guard (int pointer,int elsize,int nelem)
{
  ...
  p = (char *)&MEM + (elsize*((unsigned int)pointer-1));
  /*
...
int fill_guard (int pointer,int elsize,int nelem)
{
  char *p;
  int i;

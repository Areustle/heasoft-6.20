                         ...
                         RealArray& fluxArray, RealArray& fluxErrArray, const string& initString) const
{
  ...
  XSutility::auto_array_ptr<Real> enp(convert(energyArray));
  XSutility::auto_array_ptr<Real> parp(convert(params));
  Real* en = enp.get();
  Real* par = parp.get();
  ...
  XSutility::auto_array_ptr<float> enf(new float[nArray]);
  XSutility::auto_array_ptr<float> parf(new float[params.size()]);
  XSutility::auto_array_ptr<float> flux(new float[nEar]);
  XSutility::auto_array_ptr<float> fluxErr(new float[nEar]);
  ...
  XSutility::auto_array_ptr<Real> fluxd(new Real[nEar]);
  ...
  if (testErr < nEar)
  {
        XSutility::auto_array_ptr<Real> fluxErrd(new Real[nEar]);
                         ...
                         RealArray& fluxArray, RealArray& fluxErrArray, const string& initString) const
{
  ...
  XSutility::auto_array_ptr<Real> enp(convert(energyArray));
  XSutility::auto_array_ptr<Real> parp(convert(params));
  XSutility::auto_array_ptr<Real> flux(new Real[nEar]);
  XSutility::auto_array_ptr<Real> fluxErr(new Real[nEar]);

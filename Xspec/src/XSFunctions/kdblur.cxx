...
PROTOCCALLSFSUB7(DOKDBLUR,dokdblur,FLOATV,INT,FLOATV,INT,FLOATV,FLOATV,FLOATV)
#define DOKDBLUR(ear,ne,param,ifl,photar,tmp,tmp2)				\
  CCALLSFSUB7(DOKDBLUR,dokdblur,FLOATV,INT,FLOATV,INT,FLOATV,FLOATV,FLOATV, \
	      ear,ne,param,ifl,photar,tmp,tmp2)
        ...
        const string& initString)
{
   ...
   auto_array_ptr<float> apTmp2(new float[ne]);
   ...
   DOKDBLUR(ear, ne, pars, spectrumNumber, photar, apTmp.get(), apTmp2.get());

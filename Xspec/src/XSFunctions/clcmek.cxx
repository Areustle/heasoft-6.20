            ...
            RealArray& fluxArray)
{
  ...
  XSutility::auto_array_ptr<float> apEz(new float[ne+1]);
  float* ez = apEz.get();
  ...
  XSutility::auto_array_ptr<float> apAbun(new float[NOEL]);
  ...
  XSutility::auto_array_ptr<float> apPhotar(new float[ne]);

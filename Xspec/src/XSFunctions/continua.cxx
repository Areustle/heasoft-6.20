...
void continua(const float t, const float* ei, const float* ear, const int ne, const float z, float* workphot)
{
   ...
   auto_array_ptr<float> apCont(new float[NELEM*NFREQ]);
   ...
   auto_array_ptr<int> apZstart(new int[nmax]);
   auto_array_ptr<int> apIndexin(new int[nmax]);
   auto_array_ptr<float> apWl(new float[nmax]);
   auto_array_ptr<float> apWr(new float[nmax]);
   auto_array_ptr<float> apEcmb(new float[nmax]);
   auto_array_ptr<float> apArea(new float[nmax]);

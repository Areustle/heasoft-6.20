		 ...
		 RealArray& tableParams, Real index, RealArray& Spref)
{
  ...
  if ( tableParams[0] < 1.2 ) {
    tcout << modelName << ": A 2-10 keV slope of " << tableParams[0] << " is outside the tabulated range - setting to 1.2" << endl;
    tableParams[0] = 1.2;
  } else if ( tableParams[0] > 3.4 ) {
    tcout << modelName << ": A 2-10 keV slope of " << tableParams[0] << " is outside the tabulated range - setting to 3.4" << endl;
    tableParams[0] = 3.4;
  }

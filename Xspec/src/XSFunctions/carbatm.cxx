...
extern "C" void carbatm(const RealArray& energy, 
               ...
               const string& init)
{
  ...
  const int  TNUM   =61; //..number of tabulated temperatures
  ...
  Real Tmin = 1.0;       //..lowest tabulated temperature in MK
  ...
  directory = FunctionUtility::getModelString("CARBATM");
  if(directory.compare("$$NOT$$") == 0) { // CARBATM variable is not set
    directory = FunctionUtility::modelDataPath();
  }

  //..initialize mode filenames and tabulated logg values
  filename[0] = "spC_g137_ca1_ph.dat";
  filename[1] = "spC_g1385_ca1_ph.dat";
  filename[2] = "spC_g140_ca1_ph.dat";
  filename[3] = "spC_g1415_ca1_ph.dat";
  filename[4] = "spC_g143_ca1_ph.dat";
  filename[5] = "spC_g1445_ca1_ph.dat";
  filename[6] = "spC_g146_ca1_ph.dat";
  filename[7] = "spC_g1475_ca1_ph.dat";
  filename[8] = "spC_g149_ca1_ph.dat";

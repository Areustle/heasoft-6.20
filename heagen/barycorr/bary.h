/* RCS: $Id: bary.h,v 1.6 2012/10/17 20:27:36 craigm Exp $ */
/*-----------------------------------------------------------------------
 *
 *  bary.h
 *
 ...
 * then $LHEA_DATA ($ASCDS_CALIB, depending on what LHEADIR is set to).
 *
 *----------------------------------------------------------------------*/
...
static enum Observatory {Unknown, Geocenter, XTE, AXAF, SWIFT, NuSTAR} mission=Unknown ;
...
typedef struct {
  ...
  double ddddf ;        /* pulsar frequency fourth derivative */
...
void clockinit (enum Observatory, char*) ;
...
double *nustarscorbit (char *, double, int *) ;       /* NuSTAR-specific */
...
char *bhrcsid = "RCS: $Id: bary.h,v 1.6 2012/10/17 20:27:36 craigm Exp $" ;

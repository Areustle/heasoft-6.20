...
static void initializeInterTable (InterTable *table,
		IMAGE* original, IMAGETRANS* param)
{
	int i, j;
	double x, y;
...
static void updateBorder (InterBorder *border, IMAGETRANS *param, double x, double y)
{
	double ox, oy;
	int x0, x1, y0, y1;
...
static void initializeBorder (InterBorder *border, IMAGE *original, IMAGETRANS *param)
{
	int i;
	double x, y;
	double x0, x1, y0, y1;

*+FNDCOL
     	subroutine fndcol(chatter, iunit, nsearch, 
...
c Description 
c  Routine attempts to find an COLLRESP dataset within file already
...
c  CRSPVERS           o: Value of CRSPVERS keyword for extn found 
...
c  Ian M George (1.0.0:95 May 24) Original
c  Ian M George (1.0.1:96 Feb 04) added wtinfo & friends
      character(5) version
      parameter (version = '1.0.1')
*-
c Internals
	character(6) subname
	parameter (subname = 'fndcol')
...
c ........ Dont yet know the ext# we're after - search using HDUCLAS* keys
	   message = ' Searching for COLLRESP dataset via'//

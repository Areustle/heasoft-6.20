...
C tjdgrd.f
C $Id: tjdgrd.f,v 1.3 2013/05/21 19:08:24 irby Exp $
...
C
C Revision 1.2  1998/10/06 12:52:24  silvis
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC PROGRAM CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      SUBROUTINE TJDGRD(TJDAY,MILSEC,YEAR,MONTH,DAY,HOUR,MIN,SEC,MILLIS,
     +                  CODE)
      ...
      character(80)	rcsid
      common	/id/	rcsid
      rcsid = '$Id: tjdgrd.f,v 1.3 2013/05/21 19:08:24 irby Exp $'
...
10    IF (TJD.LE.DAYS(I)) THEN
      ...
      ELSE
         ...
         I = I + 1
         IF (I.LT.13) GOTO 10
         WRITE(6,'('' PROGRAMMING ERROR IN TJDGRD SUBROUTINE'')')
      ENDIF

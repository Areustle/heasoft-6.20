C***********************************************************************
C   SUBROUTINE CELGAL
C $Id: celgal.f,v 1.2 2013/05/21 19:08:24 irby Exp $
C***********************************************************************
C=================================================================
...
C|
C| Revision 1.1  2002/04/16 20:24:02  irby
C| New GRO tool intmap.
C|
...
C======================================================================
      ...
      save         first,twopi,conv,scpdc,ccpdc,glon0,rtasn0
...
Cesp  ! Declaring variables not declared on IBM !
      ...
      id = '$Id: celgal.f,v 1.2 2013/05/21 19:08:24 irby Exp $'

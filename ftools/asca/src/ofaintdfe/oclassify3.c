/*  FTOOLs info: $Header: /headas/headas/ftools/asca/src/ofaintdfe/oclassify3.c,v 3.7 1999/07/19 16:36:20 peachey Exp $   */
/*                   */
/*
*	grade routine 
*
...
/* normal mode */
int onormclassify_event(handle, split, sumph, type, above)
short int *handle[9];
...
/* fast mode */
int ofastclassify_event(handle, split, sumph, type, above_split)
short int *handle[3];

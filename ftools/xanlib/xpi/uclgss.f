**==uclgss.spg  processed by SPAG 4.50F  at 15:18 on 26 Aug 1994
      SUBROUTINE UCLGSS(Parname,Buffer,Status)
 
*
*     return a integer*2 value related to parname
*
      CHARACTER*(*) Parname
      INTEGER*2 Buffer
      INTEGER Status
 ...
 200  Status = 2
      ...
      ENTRY UCLGSSD(Parname,Buffer,Status)
...
c$$$
c$$$      ENTRY UCLGSSD(Parname,Buffer,Status)
c$$$
c$$$      IF ( Status.NE.0 ) RETURN
c$$$
c$$$

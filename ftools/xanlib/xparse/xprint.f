	subroutine xprint(string,iparse,nreq,descr,ndesc,bkint,
     &	 nret,iflag,idelim)
c
...
c	bint	r4	i: the integer values to pass back
...
c
	...
	call xgtint(string,iparse,nreq,descr,ndesc,bkint,nret,
     &	 iflag,idelim)
	return
	end

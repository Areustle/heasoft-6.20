...
CH1 convrt.f
CH1 $Id: convrt.f,v 3.2 2013/05/21 19:08:27 irby Exp $
...
CH9 --------------------------------------------------------------------------
CH9 $Log: convrt.f,v $
CH9 Revision 3.2  2013/05/21 19:08:27  irby
CH9 Change character*n to character(n) to silence warnings: "Obsolescent
CH9 feature: Old-style character length".
CH9
CH9 Revision 3.1  2002/04/16 20:32:07  irby
CH9 Additions to libgro - previously these codes existed in the following
CH9 libraries:
CH9
CH9   libsenstv
CH9   libsysutil
...
CHCCCCCCCCCCCCCCCCCCCCCCCCCCCCC PROGRAM CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      character(80)	rcsid
      common	/id/	rcsid
      rcsid = '$Id: convrt.f,v 3.2 2013/05/21 19:08:27 irby Exp $'

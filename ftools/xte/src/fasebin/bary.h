/* RCS: $Id: bary.h,v 1.6 2005/06/03 19:11:49 miket Exp $ */
/*-----------------------------------------------------------------------
 *
 *  bary.h
 *
...
#define ERRMSG 1024          /* Must be bigger than FLEN_ERRMSG and big enough *
			      * to accomodate any random stderr text which we  *
			      * throw at it with sprintf() (was fprintf(stderr)*/
...
char *bhrcsid = "RCS: $Id: bary.h,v 1.6 2005/06/03 19:11:49 miket Exp $" ;

/* $Id: axBary.c,v 1.3 2011/02/03 20:17:59 miket Exp $ */
/*--------------------------------------------------------------------
 *
 *    File:        axBary.c
 ...
 *
 *  03 Feb 2011 (MT) Uncommented application of timezero to tstart/tstop
 *  v1.2.1           and inserted a few debugging statements. This makes
 *                   things very similar to v1.4 which has Swift revisions
 *
 *--------------------------------------------------------------------*/
	    ...
	    double ra, double dec, char *refFrame, int debug)
{
  ...
  char *version = "axBary - $Revision: 1.3 $ $Date: 2011/02/03 20:17:59 $" ;

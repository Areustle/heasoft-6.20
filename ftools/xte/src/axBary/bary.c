char *bcrcsid = "RCS: $Id: bary.c,v 1.4 2010/09/22 17:42:28 miket Exp $" ;
/*-----------------------------------------------------------------------
 *
 *  bary.c
 *
 ...
 */
  if ( error > 0 || nocover ) {
    ...
    fprintf (stderr, "      and deposit it in $TIMING_DIR or $LHEA_DATA, \n") ;
    ...
    fprintf (stderr, "      and deposit it in $TIMING_DIR or $LHEA_DATA, or you may want\n") ;

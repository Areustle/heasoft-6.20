c
      subroutine xrftgext(lui,ichat,string,imax,iext,itype,ifound,ierr)
...
c RY - June 1995, replace rmvblk with rmvlbk and make iext(*) instead of
c iext(ifound)
...
c Write information about the extensions to stdio and log.
         ...
         CALL xrftwext(lui,ichat,ifound,iext,ierr)

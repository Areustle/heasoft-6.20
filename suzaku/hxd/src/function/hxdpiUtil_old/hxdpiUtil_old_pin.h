#ifndef _HXDPIUTIL_OLD_PIN_H_
#define _HXDPIUTIL_OLD_PIN_H_


void   hxdpiUtil_old_pin_init(char* hxd_pinghf_fname, 
			  char* hxd_pinlin_fname, 
			  int* istat);

void   hxdpiUtil_old_pin_correct(HxdEventFits02 *data,

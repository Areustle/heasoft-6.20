C
C File: g95_fileio.f
C Description: File I/O routines for g95
C
C History:
...
cc      Integer  Ftell
      Integer  cli__Fseek
C begin
cc 2006-06-04 YI, g95 built-in function Ftell seems always to return 0
cc      CLftell = Ftell( Lun )
      CLftell = cli__Fseek(Lun, 0, 1)
cc      Write (*,*) 'g95_fileio: Ftell: lun=', lun, ' pos=', CLftell
C
      Return
      End
C

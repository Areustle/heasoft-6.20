...
#ifndef lint
static char rcsid[]="@(#)$Id: proccom.c,v 1.7 2011/06/30 18:57:31 irby Exp $";
#endif
...
#if !defined (VMS) && !defined (__APPLE__) && !defined (__CYGWIN__)
#include <values.h>
#endif
...
int *retbuflen;	/* the length of retbuf */
{
	...
	unsigned short *bothbuf=0; /* buffer for sum of the two data parts */
